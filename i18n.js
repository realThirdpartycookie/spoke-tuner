...
const MESSAGES = {
  "de": {
    ...
    "build.vibLeft": "Schwingende Länge links (L_vib)",
    "build.vibRight": "Schwingende Länge rechts (L_vib)",
    "build.totalLeft": "Gesamtlänge links (L_tot)",
    "build.totalRight": "Gesamtlänge rechts (L_tot)",
    "build.lengthsNote": "L_vib = Schwinglänge vom Nippel bis zur letzten Kreuzung (bzw. Nabe). L_tot = Gesamte Speichenlänge für Dehnung und Drehungen.",
    "mode.title": "Zentriermodus",
    "mode.absolute": "Absolut (Ziel)",
    "mode.relative": "Relativ (Median)",
    "mode.absoluteHint": "Abgleich gegen feste Zielspannung je Seite.",
    "mode.relativeHint": "Homogenisierung aller Speichen gegen den aktuellen Seiten-Median.",
    "turns.tighten": "spannen",
    "turns.loosen": "lockern",
    "turns.ok": "OK (im Band)",
    "turns.turnUnit": "Umdr.",
    "turns.adviceLabel": "Nippeldrehung",
    "gauge.targetMedian": "Median",
    "calib.title": "1-Umdrehung-Kalibrierung",
    "calib.desc": "Ermittelt die tatsächliche Felgen- und Speichensteifigkeit am echten Laufrad.",
    "calib.theoretical": "Theoretisch: ~{val}/Umdr.",
    "calib.calibrated": "Kalibriert: {val}/Umdr.",
    "calib.startBtn": "Assistent starten",
    "calib.resetBtn": "Auf Formel zurücksetzen",
    "calib.step1": "Schritt 1: Referenzspeiche zupfen ({hz1} Hz)",
    "calib.step2": "Schritt 2: Nippel genau 1 Umdrehung fester anziehen (+1 Drehung), dann erneut zupfen.",
    "calib.saveBtn": "Kalibrierung übernehmen ({val}/Umdr.)",
    "calib.cancelBtn": "Abbrechen",
    "toast.calibrated": "1-Turn-Kalibrierung gespeichert ({val}/Umdr.).",
    "diag.tooShort": "Klang zu kurz — kräftiger zupfen, näher ans Mikrofon halten.",
    "diag.unsteady": "Unruhiger Ton — Speichenkreuzung mit dem Daumen abdämpfen."
  },
  "en": {
    "nav.measure": "Measure",
    "nav.wheel": "Wheel",
    ...
    "build.vibLeft": "Vibrating length left (L_vib)",
    "build.vibRight": "Vibrating length right (L_vib)",
    "build.totalLeft": "Total length left (L_tot)",
    "build.totalRight": "Total length right (L_tot)",
    "build.lengthsNote": "L_vib = vibrating length from nipple to last crossing (or hub). L_tot = total spoke length for elongation and turns.",
    "mode.title": "Truing mode",
    "mode.absolute": "Absolute (target)",
    "mode.relative": "Relative (median)",
    "mode.absoluteHint": "Comparison against fixed target tension per side.",
    "mode.relativeHint": "Homogenize all spokes against the current side median.",
    "turns.tighten": "tighten",
    "turns.loosen": "loosen",
    "turns.ok": "OK (in band)",
    "turns.turnUnit": "turn",
    "turns.adviceLabel": "Nipple turns",
    "gauge.targetMedian": "Median",
    "calib.title": "1-Turn Calibration",
    "calib.desc": "Measures the actual rim and spoke stiffness on the real wheel.",
    "calib.theoretical": "Theoretical: ~{val}/turn",
    "calib.calibrated": "Calibrated: {val}/turn",
    "calib.startBtn": "Start wizard",
    "calib.resetBtn": "Reset to formula",
    "calib.step1": "Step 1: Pluck reference spoke ({hz1} Hz)",
    "calib.step2": "Step 2: Tighten nipple exactly 1 full turn (+1 turn), then pluck again.",
    "calib.saveBtn": "Save calibration ({val}/turn)",
    "calib.cancelBtn": "Cancel",
    "toast.calibrated": "1-turn calibration saved ({val}/turn).",
    "diag.tooShort": "Tone too short — pluck firmer, hold closer to the microphone.",
    "diag.unsteady": "Unsteady pitch — damp the spoke crossing with your thumb."
  },
  "fr": {
    "nav.measure": "Mesurer",
    "nav.wheel": "Roue",
    ...
    "build.vibLeft": "Longueur vibrante gauche (L_vib)",
    "build.vibRight": "Longueur vibrante droite (L_vib)",
    "build.totalLeft": "Longueur totale gauche (L_tot)",
    "build.totalRight": "Longueur totale droite (L_tot)",
    "build.lengthsNote": "L_vib = longueur vibrante de l'écrou au dernier croisement (ou moyeu). L_tot = longueur totale du rayon pour l'élongation et les tours.",
    "mode.title": "Mode de dévoilage",
    "mode.absolute": "Absolu (cible)",
    "mode.relative": "Relatif (médiane)",
    "mode.absoluteHint": "Comparaison avec la tension cible fixe par côté.",
    "mode.relativeHint": "Homogénéiser tous les rayons par rapport à la médiane actuelle du côté.",
    "turns.tighten": "serrer",
    "turns.loosen": "desserrer",
    "turns.ok": "OK (dans la plage)",
    "turns.turnUnit": "tour",
    "turns.adviceLabel": "Tours d'écrou",
    "gauge.targetMedian": "Médiane",
    "calib.title": "Étalonnage 1 tour",
    "calib.desc": "Mesure la rigidité réelle de la jante et du rayon sur la roue réelle.",
    "calib.theoretical": "Théorique: ~{val}/tour",
    "calib.calibrated": "Étalonné: {val}/tour",
    "calib.startBtn": "Démarrer l'assistant",
    "calib.resetBtn": "Réinitialiser à la formule",
    "calib.step1": "Étape 1: Pincez le rayon de référence ({hz1} Hz)",
    "calib.step2": "Étape 2: Serrez l'écrou d'exactement 1 tour (+1 tour), puis pincez à nouveau.",
    "calib.saveBtn": "Enregistrer l'étalonnage ({val}/tour)",
    "calib.cancelBtn": "Annuler",
    "toast.calibrated": "Étalonnage 1 tour enregistré ({val}/tour).",
    "diag.tooShort": "Son trop court — pincez plus fort, rapprochez du microphone.",
    "diag.unsteady": "Hauteur instable — étouffez le croisement des rayons avec le pouce."
  },
  "es": {
    "nav.measure": "Medir",
    "nav.wheel": "Rueda",
    ...
    "build.vibLeft": "Longitud vibrante izquierda (L_vib)",
    "build.vibRight": "Longitud vibrante derecha (L_vib)",
    "build.totalLeft": "Longitud total izquierda (L_tot)",
    "build.totalRight": "Longitud total derecha (L_tot)",
    "build.lengthsNote": "L_vib = longitud vibrante de cabecilla al último cruce (o buje). L_tot = longitud total del radio para elongación y giros.",
    "mode.title": "Modo de centrado",
    "mode.absolute": "Absoluto (objetivo)",
    "mode.relative": "Relativo (mediana)",
    "mode.absoluteHint": "Comparación con la tensión objetivo fija por lado.",
    "mode.relativeHint": "Homogeneizar todos los radios con respecto a la mediana actual del lado.",
    "turns.tighten": "tensar",
    "turns.loosen": "aflojar",
    "turns.ok": "OK (en rango)",
    "turns.turnUnit": "vuelta",
    "turns.adviceLabel": "Giros de cabecilla",
    "gauge.targetMedian": "Mediana",
    "calib.title": "Calibración de 1 vuelta",
    "calib.desc": "Mide la rigidez real de llanta y radio en la rueda real.",
    "calib.theoretical": "Teórico: ~{val}/vuelta",
    "calib.calibrated": "Calibrado: {val}/vuelta",
    "calib.startBtn": "Iniciar asistente",
    "calib.resetBtn": "Restablecer a fórmula",
    "calib.step1": "Paso 1: Pulse el radio de referencia ({hz1} Hz)",
    "calib.step2": "Paso 2: Apriete la cabecilla exactamente 1 vuelta completa (+1 vuelta), luego pulse de nuevo.",
    "calib.saveBtn": "Guardar calibración ({val}/vuelta)",
    "calib.cancelBtn": "Cancelar",
    "toast.calibrated": "Calibración de 1 vuelta guardada ({val}/vuelta).",
    "diag.tooShort": "Sonido demasiado corto — pulse con más fuerza, acerque al micrófono.",
    "diag.unsteady": "Tono inestable — amortigüe el cruce de radios con el pulgar."
  },
  "it": {
    ...
    "build.vibLeft": "Lunghezza vibrante sinistra (L_vib)",
    "build.vibRight": "Lunghezza vibrante destra (L_vib)",
    "build.totalLeft": "Lunghezza totale sinistra (L_tot)",
    "build.totalRight": "Lunghezza totale destra (L_tot)",
    "build.lengthsNote": "L_vib = lunghezza vibrante dal nipplo all'ultimo incrocio (o mozzo). L_tot = lunghezza totale del raggio per allungamento e giri.",
    "mode.title": "Modo di centratura",
    "mode.absolute": "Assoluto (target)",
    "mode.relative": "Relativo (mediana)",
    "mode.absoluteHint": "Confronto con la tensione target fissa per lato.",
    "mode.relativeHint": "Omogeneizzare tutti i raggi rispetto alla mediana attuale del lato.",
    "turns.tighten": "tirare",
    "turns.loosen": "allentare",
    "turns.ok": "OK (in tolleranza)",
    "turns.turnUnit": "giro",
    "turns.adviceLabel": "Giri del nipplo",
    "gauge.targetMedian": "Mediana",
    "calib.title": "Calibrazione 1 giro",
    "calib.desc": "Misura la rigidità effettiva di cerchio e raggio sulla ruota reale.",
    "calib.theoretical": "Teorico: ~{val}/giro",
    "calib.calibrated": "Calibrato: {val}/giro",
    "calib.startBtn": "Avvia assistente",
    "calib.resetBtn": "Ripristina formula",
    "calib.step1": "Passo 1: Pizzicare il raggio di riferimento ({hz1} Hz)",
    "calib.step2": "Passo 2: Stringere il nipplo esattamente di 1 giro completo (+1 giro), poi pizzicare di nuovo.",
    "calib.saveBtn": "Salva calibrazione ({val}/giro)",
    "calib.cancelBtn": "Annulla",
    "toast.calibrated": "Calibrazione 1 giro salvata ({val}/giro).",
    "diag.tooShort": "Suono troppo breve — pizzicare più forte, avvicinare al microfono.",
    "diag.unsteady": "Tono instabile — smorzare l’incrocio dei raggi con il pollice."
  },
  "nl": {
    "nav.measure": "Meten",
    "nav.wheel": "Wiel",
    ...
    "build.vibLeft": "Trillende lengte links (L_vib)",
    "build.vibRight": "Trillende lengte rechts (L_vib)",
    "build.totalLeft": "Totale lengte links (L_tot)",
    "build.totalRight": "Totale lengte rechts (L_tot)",
    "build.lengthsNote": "L_vib = trillende lengte van nippel tot laatste kruising (of naaf). L_tot = totale spaaklengte voor rek en omwentelingen.",
    "mode.title": "Centreermodus",
    "mode.absolute": "Absoluut (doel)",
    "mode.relative": "Relatief (mediaan)",
    "mode.absoluteHint": "Vergelijking met vaste doelspanning per zijde.",
    "mode.relativeHint": "Homogeniseer alle spaken tegen de huidige zijwaartse mediaan.",
    "turns.tighten": "spannen",
    "turns.loosen": "lossen",
    "turns.ok": "OK (in bereik)",
    "turns.turnUnit": "omw.",
    "turns.adviceLabel": "Nippelomwentelingen",
    "gauge.targetMedian": "Mediaan",
    "calib.title": "1-omwenteling-kalibratie",
    "calib.desc": "Bepaalt de werkelijke velg- en spaakstijfheid op het echte wiel.",
    "calib.theoretical": "Theoretisch: ~{val}/omw.",
    "calib.calibrated": "Gekalibreerd: {val}/omw.",
    "calib.startBtn": "Start assistent",
    "calib.resetBtn": "Herstel naar formule",
    "calib.step1": "Stap 1: Tokkel referentiespaak ({hz1} Hz)",
    "calib.step2": "Stap 2: Draai de nippel precies 1 omwenteling vaster (+1 slag) en tokkel opnieuw.",
    "calib.saveBtn": "Kalibratie opslaan ({val}/omw.)",
    "calib.cancelBtn": "Annuleren",
    "toast.calibrated": "1-omwenteling-kalibratie opgeslagen ({val}/omw.).",
    "diag.tooShort": "Toon te kort — krachtiger tokkelen, dichter bij de microfoon houden.",
    "diag.unsteady": "Onrustige toon — demp de spaakkruising met uw duim."
  }
};
